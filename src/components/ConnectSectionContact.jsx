...
export default function ConnectSectionContact() {
  ...
  useEffect(() => {
    ...
    const resizeObserver = new ResizeObserver(([entry]) => {
      ...
      globe = createGlobe(canvas, {
        ...
        glowColor: [0.3137, 0.9803, 0.5686],
        markers: [
  ...
  return (
    <motion.div
      className="text-center min-h-screen flex flex-col justify-center items-center bg-[#50fa91] text-black -mt-8 px-4 py-5"
      initial={{ opacity: 0 }}
    ...
    >
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-3">
        ...
        <span className="text-black">Abhirang</span>
      </h1>
